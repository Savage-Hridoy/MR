...
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m Ridoy Ahmed

\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m+01647××××××

\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mjeetu006/savage-Hridoy
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/bal.pakna.04 ")
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-open https://www.facebook.com/bal.pakna.04")
...
def crack2(idf,pwv):
	...
	print('\r%s [𝐅𝐋𝐀𝐌𝐄] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
